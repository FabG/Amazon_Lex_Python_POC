...
VERIFIED_EMAIL = 'fabrice.guillaume@gmail.com'

# Phone numbers must included the plus and country code
PHONE_NUMBER = '+17039281851'
...
def send_email_alerts(to_addresses, alert_level):
    ...
    print('Alert email sent to ' + VERIFIED_EMAIL)
...
def send_sms_alerts(numbers, alert_level):
    for number in numbers:
        ...
        print('Alert SMS sent to ' + number)



def send_alerts(level):
    print("Running an alerting playbook of email and (sometimes) text alerts")
